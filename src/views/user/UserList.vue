<template>
            ...
            <el-col :span="8">
              <div class="my-button">
                ...
                <el-button @click="exportExcelAction" type="primary">
                  <el-icon style="margin-right: 6px"><Download /></el-icon>导出
                  Excel
                </el-button>
              </div>
            </el-col>
  ...
  <el-dialog
    align-center
    v-model="editUserDialogFormVisible"
    width="42%"
    destroy-on-close
  >
    <template #header="{ close, titleId, titleClass }">
...
const { tableData, pageIndex, pageSize, loading, total, status, searchValue } =
  toRefs(state);
</script>
